...
export class Weav3Factory__parametersResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: i32;
...
export class Weav3Factory extends ethereum.SmartContract {
  static bind(address: Address): Weav3Factory {
    return new Weav3Factory("Weav3Factory", address);
  }
  ...
  try_enhancedSwapFee(): ethereum.CallResult<i32> {
    let result = super.tryCall(
      "enhancedSwapFee",
      "enhancedSwapFee():(uint24)",
      []
  ...
  enhancedSwapState(): boolean {
    let result = super.call(
      "enhancedSwapState",
      "enhancedSwapState():(bool)",
      []
    );
  ...
  try_enhancedSwapState(): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "enhancedSwapState",
      "enhancedSwapState():(bool)",
      []
  ...
  parameters(): Weav3Factory__parametersResult {
    let result = super.call(
      "parameters",
    ...
    return new Weav3Factory__parametersResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toI32(),
  ...
  try_parameters(): ethereum.CallResult<Weav3Factory__parametersResult> {
    let result = super.tryCall(
      "parameters",
      "parameters():(address,address,address,uint24,int24)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new Weav3Factory__parametersResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toI32(),
  ...
  receiverEnhancedSwapFee(): Address {
    let result = super.call(
      "receiverEnhancedSwapFee",
      "receiverEnhancedSwapFee():(address)",
      []
    );
  ...
  try_receiverEnhancedSwapFee(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "receiverEnhancedSwapFee",
      "receiverEnhancedSwapFee():(address)",
      []
...
export class SetEnhancedSwapFeeCall extends ethereum.Call {
  get inputs(): SetEnhancedSwapFeeCall__Inputs {
    return new SetEnhancedSwapFeeCall__Inputs(this);
  }

  get outputs(): SetEnhancedSwapFeeCall__Outputs {
    return new SetEnhancedSwapFeeCall__Outputs(this);
  }
}

export class SetEnhancedSwapFeeCall__Inputs {
  _call: SetEnhancedSwapFeeCall;

  constructor(call: SetEnhancedSwapFeeCall) {
    this._call = call;
  }
...
export class SetEnhancedSwapFeeCall__Outputs {
  _call: SetEnhancedSwapFeeCall;
